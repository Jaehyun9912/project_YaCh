...
# 승리 처리 (보상 계산 포함)
func process_win(map_data: Dictionary):
	var reward_text = _calculate_and_give_rewards(map_data)
...
# 보상 계산 및 지급
func _calculate_and_give_rewards(map_data: Dictionary) -> String:
	var reward_str = ""
